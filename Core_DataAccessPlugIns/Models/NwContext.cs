...
public partial class NwContext : DbContext
{
    ...
    public virtual DbSet<OrderDetailsDynamic> OrderDetailsDynamics { get; set; }
...
//        => optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=nw;Integrated Security=SSPI;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<OrderDetailsDynamic>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("OrderDetailsDynamic");
